...
CREATE TABLE `snapshot-sequencer`.spaces (
...
CREATE TABLE `snapshot-sequencer`.proposals (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.votes (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.follows (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.aliases (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
  address VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.subscriptions (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
  address VARCHAR(64) NOT NULL,
  space VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.users (
  id VARCHAR(64) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
  profile JSON,
  created INT(11) NOT NULL,
...
CREATE TABLE `snapshot-sequencer`.statements (
  id VARCHAR(64) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
