CREATE DATABASE IF NOT EXISTS `snapshot-hub`;
CREATE TABLE `snapshot-hub`.spaces (
...
CREATE TABLE `snapshot-hub`.proposals (
...
CREATE TABLE `snapshot-hub`.votes (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-hub`.follows (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-hub`.aliases (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-hub`.subscriptions (
  id VARCHAR(66) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
  address VARCHAR(64) NOT NULL,
  space VARCHAR(64) NOT NULL,
...
CREATE TABLE `snapshot-hub`.users (
  id VARCHAR(64) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
  profile JSON,
  created INT(11) NOT NULL,
...
CREATE TABLE `snapshot-hub`.statements (
  id VARCHAR(64) NOT NULL,
  ipfs VARCHAR(64) NOT NULL,
